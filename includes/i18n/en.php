...
$i18n = [
    ...
    "page_background_info" => "Choose a preset, solid color, or image for light and dark mode. Leave as default to use the built-in background.",
    "bg_desktop_light" => "Light",
    "bg_desktop_dark" => "Dark",
    "bg_mobile_light" => "Light",
    "bg_mobile_dark" => "Dark",
