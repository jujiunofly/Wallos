...
$i18n = [
    ...
    "enable_glass" => "Enable frosted glass on cards",
    "glass_blur" => "Blur",
    "glass_opacity" => "Opacity",
    "page_background" => "Page background",
    "page_background_info" => "Choose a preset, solid color, or image for each device and theme. Leave as default to use the built-in background.",
    "bg_desktop_light" => "Desktop · Light",
    "bg_desktop_dark" => "Desktop · Dark",
    "bg_mobile_light" => "Mobile · Light",
    "bg_mobile_dark" => "Mobile · Dark",
    ...
    "media_in_use" => "This image is in use and cannot be deleted",
    "replace_image" => "Replace image",
    "app_icon" => "App icon",
    "app_icon_info" => "Shown at the top of the sidebar on desktop, and in the header on mobile. A transparent PNG or SVG works best.",
    "reset_app_icon" => "Reset to default",
    "toggle_sidebar" => "Sidebar / classic header",
    "favicon" => "Favicon",
    "favicon_info" => "The small icon in the browser tab. A square PNG works best.",
    "reset_favicon" => "Reset favicon",
    "header_title" => "Header text",
    "header_title_placeholder" => "Shown on the left of the header. Leave empty to hide.",
    "header_title_size" => "Header text size",
    "name" => "Name",
    ...
    "colors" => "Colors",
    "colors_light" => "Light theme colors",
    ...
    "backup_api" => "Backup download link",
    "backup_api_info" => "Open this URL with the admin API key to download a full backup (database and uploaded logos). Keep it secret.",
    "account" => "Account",
    ...
    "calendar_time_hint" => "The calendar uses app time to decide today and the current month. Compare it with your local time if days look off.",
    // TOTP Page
