...
$i18n = [
    ...
    "glass_effect" => "磨砂玻璃",
    "enable_glass" => "为卡片启用磨砂玻璃",
    "glass_blur" => "模糊",
    "glass_opacity" => "不透明度",
    "page_background" => "页面背景",
    "page_background_info" => "可按电脑/手机和浅色/深色分别选择预设渐变、纯色或图片。默认则使用系统背景。",
    "bg_desktop_light" => "电脑 · 浅色",
    "bg_desktop_dark" => "电脑 · 深色",
    "bg_mobile_light" => "手机 · 浅色",
    "bg_mobile_dark" => "手机 · 深色",
    "solid_color" => "纯色",
    "background_image" => "图片",
    ...
    "choose_image" => "选择图片",
    "upload_image" => "上传图片",
    "media_in_use" => "这张图片正在使用，无法删除",
    "replace_image" => "换一张",
    "app_icon" => "应用图标",
    "app_icon_info" => "显示在左侧栏顶部，手机端显示在顶栏。建议使用透明底 PNG 或 SVG。",
    "reset_app_icon" => "恢复默认图标",
    "toggle_sidebar" => "侧栏 / 原版顶栏",
    "favicon" => "网页小图标",
    "favicon_info" => "浏览器标签页上的小图标，建议使用正方形 PNG。",
    "reset_favicon" => "恢复默认小图标",
    "header_title" => "页眉文字",
    "header_title_placeholder" => "显示在页眉左侧，可留空",
    "header_title_size" => "页眉文字大小",
    "name" => "名称",
    "last_added" => "创建时间",
    "price" => "价格",
    "next_payment" => "下次支付时间",
    ...
    "active_subscriptions" => "在用订阅",
    "inactive_subscriptions" => "停用订阅",
    "monthly_cost" => "月度订阅费用",
    "yearly_cost" => "年度订阅费用",
    "average_monthly" => "月度平均订阅费用",
    "most_expensive" => "最贵订阅费用",
    "amount_due" => "本月待付金额",
    "percentage_budget_used" => "预算使用百分比",
    "budget_remaining" => "剩余预算",
    "amount_over_budget" => "超出预算金额",
    ...
    "cost_vs_period_budget" => "费用与周期预算对比",
    "send_period_summary_at_period_start" => "在每个付款周期开始时发送摘要",
    ...
    "from_email" => "发件人邮箱（可选）",
    "send_to_other_emails" => "同时发送通知到以下电子邮件地址（使用 ; 分隔它们）：",
    ...
    "ai_recommendations_info" => "AI 建议是基于您的订阅和家庭成员生成的。",
    "may_take_time" => "根据提供商、模型和订阅数量，建议的生成可能需要一些时间。",
    "recommendations_visible_on_dashboard" => "建议将在仪表板上可见。",
    ...
    "calculate_monthly_price" => "计算并显示所有订阅的月度价格",
    "convert_prices" => "始终按我的主要货币转换和显示价格（较慢）",
    "show_original_price" => "当进行转换或计算时，同步显示原始价格",
    "experience" => "体验",
    "show_subscription_progress" => "显示订阅进度",
    "progress_style_bar" => "横条",
    ...
    "backup_api" => "备份下载链接",
    "backup_api_info" => "用管理员 API 密钥打开此链接即可下载完整备份（数据库和已上传的 Logo）。请勿分享。",
    "account" => "账户",
    ...
    "require_email_verified_linking" => "账号关联需要已验证的电子邮件",
    ...
    "over_budget_warning" => "已超出预算",
    "app_time" => "应用时间",
    "local_time" => "本机时间",
    "calendar_time_hint" => "日历用应用时间判断“今天”和当前月份。如果日期对不上，请对照本机时间。",
    ...
    "week_starts_on_sunday" => "日历中一周从周日开始",
    "list_view" => "列表视图",
    "grid_view" => "网格视图",
