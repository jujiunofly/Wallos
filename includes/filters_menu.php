<div class="filtermenu-content">
  ...
  if (count($members) > 1) {
    ...
    <div class="filtermenu-submenu">
      <div class="filter-title" onClick="toggleSubMenu('member')">
        <span class="filter-title-label"><i class="fa-solid fa-user"></i><?= translate("member", $i18n) ?></span>
  ...
  if (count($categories) > 1) {
    ?>
    <div class="filtermenu-submenu">
      <div class="filter-title" onClick="toggleSubMenu('category')">
        <span class="filter-title-label"><i class="fa-solid fa-folder"></i><?= translate("category", $i18n) ?></span>
        <i class="fa-solid fa-chevron-down filter-caret"></i>
      </div>
  ...
  if (count($payment_methods) > 1) {
    ?>
    <div class="filtermenu-submenu">
      <div class="filter-title" onClick="toggleSubMenu('payment')">
        <span class="filter-title-label"><i class="fa-solid fa-credit-card"></i><?= translate("payment_method", $i18n) ?></span>
        <i class="fa-solid fa-chevron-down filter-caret"></i>
      </div>
  ...
  if (!isset($settings['hideDisabledSubscriptions']) || $settings['hideDisabledSubscriptions'] !== 'true') {
    ?>
    <div class="filtermenu-submenu">
      <div class="filter-title" onClick="toggleSubMenu('state')">
        <span class="filter-title-label"><i class="fa-solid fa-toggle-on"></i><?= translate("state", $i18n) ?></span>
        <i class="fa-solid fa-chevron-down filter-caret"></i>
      </div>
  ...
  <div class="filtermenu-submenu">
    <div class="filter-title" onClick="toggleSubMenu('renewal_type')">
      <span class="filter-title-label"><i class="fa-solid fa-rotate"></i><?= translate("renewal_type", $i18n) ?></span>
      <i class="fa-solid fa-chevron-down filter-caret"></i>
    </div>
  ...
  <div class="filtermenu-submenu">
    <div class="filter-title" onClick="toggleSubMenu('notification')">
      <span class="filter-title-label"><i class="fa-solid fa-bell"></i><?= translate("notifications", $i18n) ?></span>
      <i class="fa-solid fa-chevron-down filter-caret"></i>
    </div>
