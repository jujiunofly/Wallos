<?php
$currentSortDirection = wallos_sort_direction($sortOrder);
?>
<div class="sort-options" id="sort-options">
    <div class="sort-direction">
        <button type="button" class="<?= $currentSortDirection === 'ASC' ? 'selected' : '' ?>" data-direction="ASC" onClick="setSortDirection('ASC')">
            <i class="fa-solid fa-arrow-up-short-wide"></i> <?= translate('sort_asc', $i18n) ?>
        </button>
        <button type="button" class="<?= $currentSortDirection === 'DESC' ? 'selected' : '' ?>" data-direction="DESC" onClick="setSortDirection('DESC')">
            <i class="fa-solid fa-arrow-down-wide-short"></i> <?= translate('sort_desc', $i18n) ?>
        </button>
    </div>
    <ul>
        <li class="sort-group-label"><?= translate('sort_time', $i18n) ?></li>
        ...
        <li class="sort-group-label"><?= translate('sort_amount', $i18n) ?></li>
        <li <?= $sortOrder == "price" ? 'class="selected"' : "" ?> onClick="setSortOption('price')" id="sort-price">
            <?= translate('price', $i18n) ?>
        </li>
        <li class="sort-group-label"><?= translate('sort_details', $i18n) ?></li>
